...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    ...
    <%@include file="/assets/css/admin_sidebar.css"%>
    	<%@include file="/assets/css/admin_participant.css"%>
    </style>
		...
		<div class ="content">
			...
			<div class="category">
				<div class="submission">
                    ...
                    <label for="bill" >View Water Bill</p>
                    <a href="<c:url value='/' />"><input type="button" id="bill" style="display: none;"></a>
                </div>
                <div class="submission">
                    <i class="fa-solid fa-bolt"></i>
                    <label for="bill" >View Electricity Bill</p>
                    <a href="<c:url value='/admin/view_electricity' />?username=${user.username}"><input type="button" id="bill" style="display: none;"></a>
                </div>
				<div class="submission">
					<i class="fa-solid fa-recycle"></i>
               	 	<label for="bill" >View Oil Consumption</p>
               		 <a href="<c:url value='/' />"><input type="button" id="bill" style="display: none;"></a>
				</div>
			</div>
		</div>
