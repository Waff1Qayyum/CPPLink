...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    ...
    <%@include file="/assets/css/admin_sidebar.css"%>
    	<%@include file="/assets/css/admin_competition.css"%>
    </style>
...
<body>
    ...
    <div class="container">
		<div class ="content">
			...
			<div class="user">
			<c:forEach var="e" items="${electric}">
				<a href="<c:url value="/admin/participant_detail" />?username=${e.username}">${e.username }</a>
			</c:forEach>
			</div>
		</div>
	</div>
