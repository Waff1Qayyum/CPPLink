...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <style>
    	<%@include file="/assets/css/carbon.css"%>
    </style>
    ...
    <div class="container">
        <div class="content-container">
            <div class="left-container">
                ...
                <img src="${pageContext.request.contextPath}/assets/images/mbip.png" id="map">
                <h3 id="ghg">GHG Emission</h3>
                <img src="${pageContext.request.contextPath}/assets/images/ghg.png" id="graph">
            </div>
            <div class="right-container">
                <h3>Project Impact</h3>
                <div class="location">
                    <p>Water (Kg of CO2)</p>
                    <p>Recycle (Kg of CO2)</p>
                    <p>Electric (Kg of CO2)</p>
                    <br>
                    <p>Participation</p><br>
                    <p>Total Carbon Reduction</p>
                </div>
                <h3>Details</h3>
                <div class="location" id="detail">
                    <p>Potential reduction on absolute GHG Emission</p>
                    <h1>41%</h1>
                    <p>by 2030</p>
                </div>
            </div>
